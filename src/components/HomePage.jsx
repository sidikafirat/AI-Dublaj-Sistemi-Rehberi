...
import { FaRobot, FaCogs, FaProjectDiagram, FaInfoCircle } from 'react-icons/fa';
        ...
        <Row className="align-items-center">
          <Col md={6}>
            ...
            <p className="lead mb-4">
              ...
              çözümümüzle içeriklerinizi küresel izleyicilere ulaştırın.
            </p>
            <button className="demo-buton">
              <FaPlay />Demo'yu Deneyin
            </button>
          </Col>
          <Col md={6}>
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100 feature-card">
              <Card.Body>
                ...
                <p>
                  20+ dilde çeviri ve seslendirme imkanı.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4} className="mb-4">
            <Card className="h-100 feature-card">
              <Card.Body>
                ...
                <p>
                  Yapay zeka ile üretilmiş doğal ve akıcı sesler.
                </p>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row className="justify-content-center">
          <Col md={8}>
            <p className="text-center">
              AI Dubbing Pro, yapay zeka teknolojilerini kullanarak video içeriklerinizi
              kolayca farklı dillere çevirmenizi sağlayan bir platformdur. Amacımız, dil
              engelini ortadan kaldırarak içerik üreticilerine küresel bir erişim sağlamaktır.
            </p>
          </Col>
        </Row>
      </section>
